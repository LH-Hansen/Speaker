...
WebController::WebController(AudioController &audioController)
    : _audioController(audioController)
{
}

void WebController::handleClient(WiFiClient client)
{
    if (!client)
        return;
...
void WebController::handleSliderRequest(WiFiClient &client, const String &requestLine)
{
...
void WebController::handleAudioRequest(WiFiClient &client)
{
    String json = "{";
...
int WebController::getQueryInt(const String &requestLine, const String &key)
{
    String search = key + "=";
...
void WebController::sendResponse(WiFiClient &client,
